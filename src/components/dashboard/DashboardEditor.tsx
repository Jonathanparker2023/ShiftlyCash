...
function WeekStripCell({
  ...
  return (
    <button
        className={
          isFocused
          ? `min-w-0 scale-105 rounded-md border-[3px] ${toneBorderFocused} bg-black/30 px-1.5 py-2 text-left ${toneGlowFocused} backdrop-blur-xl transition-all duration-200 focus:outline-none sm:aspect-square sm:flex sm:flex-col sm:items-stretch sm:justify-start sm:p-2 sm:text-center`
          : day.spendLocked
            ? `min-w-0 rounded-md border-2 ${toneBorder} bg-black/10 px-1.5 py-2 text-left opacity-75 ${toneGlow} backdrop-blur-lg transition hover:bg-black/20 focus:outline-none sm:aspect-square sm:flex sm:flex-col sm:items-stretch sm:justify-start sm:p-2 sm:text-center`
            : `min-w-0 rounded-md border-2 ${toneBorder} bg-black/10 px-1.5 py-2 text-left ${toneGlow} backdrop-blur-xl transition hover:bg-black/20 focus:outline-none sm:aspect-square sm:flex sm:flex-col sm:items-stretch sm:justify-start sm:p-2 sm:text-center`
      }
    ...
    >
      ...
      <div className="hidden sm:flex sm:items-center sm:justify-center sm:gap-1 sm:text-[10px] sm:font-semibold sm:uppercase sm:tracking-[0.12em] sm:text-white">
        <span className="truncate">{formatMonDayLabel(day.date)}</span>
        {isToday ? (
          <span className="rounded-full bg-white/20 px-1.5 py-0.5 text-[9px] font-semibold text-white">
            Today
          </span>
        ) : null}
        {day.spendLocked ? (
      ...
      <p
        className={`mt-2 truncate text-xs font-bold tracking-tight sm:m-0 sm:flex sm:flex-1 sm:items-center sm:justify-center sm:text-xl ${cashflowDailyColor(
          displayCashflowCents,
