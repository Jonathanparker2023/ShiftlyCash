...
function WeeklyHistoryRow({
  ...
  return (
    <div className="grid gap-2 rounded-md border border-white/15 bg-black/20 p-3 text-sm text-white sm:grid-cols-[minmax(150px,1fr)_repeat(3,minmax(90px,0.45fr))] sm:items-center">
      <div>
